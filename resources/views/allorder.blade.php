        ...
        <table class="table">
          <thead class="table__thead">
            <tr class="table__head">
              ...
              <th class="table__th">BUYER EMAIL</th>
              <th class="table__th">BUYER NAME</th>
              <th class="table__th">PURCHASE DATE AND TIME</th>
              <th class="table__th">ADDRESS</th>
              <th class="table__th">RAZORPAY PAYMENT ID</th>
            </tr>
          </thead>
          ...
          <tbody class="table__tbody">
            <tr class="table__tr">
              <td class="table__td table__mobile-title"> <!-- table__mobile-title-->
                <span class="table__value"><img src="{{ asset('/storage').'/'.$orders->imgurl}}" alt="..."
                  style="height:80px;width:80px;" class="image-responsive"></span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->pname}}</span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->price}}</span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->quantity}}</span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->buyeremail}}</span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->fname." ".$orders->lname}}</span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->purchasedatetime}}</span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->address}}</span>
              </td>
              <td class="table__td">
                <span class="table__value">{{$orders->razorpaypaymentid}}</span>
              </td>
            </tr>
          </tbody>
          @endforeach

              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">PLEASE ENTER THIS PASSWORD FOR LOGIN, <div 
                        style="text-align:center; color: darkblue; border:2px solid blue; background-color:aquamarine"><br><b>{{session('forgotpassword');}}</b></div></p>
